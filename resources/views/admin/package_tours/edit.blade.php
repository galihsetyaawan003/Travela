                ...
                <form method="POST" action="{{route('admin.package_tours.update',$packageTour)}}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category_id" id="category_id" class="py-3 rounded-lg pl-3 w-full border border-slate-300">
                            <option value="{{$packageTour->category->id}}">{{$packageTour->category->name}}</option>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="about" id="about" cols="30" rows="5" class="border border-slate-300 rounded-xl w-full">{{$packageTour->about}}
                        </textarea>
